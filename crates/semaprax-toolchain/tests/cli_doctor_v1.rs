...
fn default_is_source_contributor_mode_and_json_is_canonical() {
    ...
    assert_eq!(
        outcome.output,
        "{\"schema\":\"semaprax.doctor.v1\",\"target\":\"contributor\",\"checks\":[{\"id\":\"semaprax\",\"required\":true,\"status\":\"ok\",\"detail\":\"0.4.1\"},{\"id\":\"os\",\"required\":true,\"status\":\"ok\",\"detail\":\"test-os\"},{\"id\":\"arch\",\"required\":true,\"status\":\"ok\",\"detail\":\"test-arch\"},{\"id\":\"release\",\"required\":true,\"status\":\"ok\",\"detail\":\"debug\"},{\"id\":\"rust\",\"required\":true,\"status\":\"ok\",\"detail\":\"rustc 1.88.0 (fake 2026-01-01)\"}]}\n"
    );
    assert_eq!(
        *host.calls.borrow(),

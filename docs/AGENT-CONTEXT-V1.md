...
the four Graph-v9-supported filters.
...
Graph v9 supports exact compact `contracts`, parameter/result `ownership`,
...
not claimed by this v1 projection. Graph v9 has no target, diagnostic, or test nodes.

...
| iOS | Partial | Existing private static callable runtime plus a Swift 6 same-thread host, device/universal-Simulator XCFramework construction, and two installed arm64-Simulator app paths are green in [run 31333469714, job 93295293995](https://github.com/wavect/semaprax/actions/runs/31333469714/job/93295293995) | Public native/Swift host, distributable framework/app project, UIKit/SwiftUI adapter, lifecycle, accessibility, signing metadata, and physical-device plus representative simulator samples verified |

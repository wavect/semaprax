...
| C and Objective-C | Partial; local Project-v8, v9 and v11 C11 provider/consumer evidence independently compiles, links and executes owned-byte, flat-record and nested multi-owner integration ABIs at O0/O2, including poison preservation and handle settlement | [C Header v1](C-HEADER-V1.md), [Project v8 C/C++ owned-data package v1](PUBLIC-CXX-OWNED-DATA-PACKAGE-V1.md), [Public Flat Owned Record API v1](PUBLIC-FLAT-OWNED-RECORD-API-V1.md), [Public Nested Owned-Record API v1](PUBLIC-NESTED-OWNED-RECORD-API-V1.md) | Broader import/export, variant/resource ownership, Objective-C adapters, cross-platform consumers, compatibility, maintained distribution, and supported-host conformance are verified. |

...
| Project Revision Store v1 follow-on | Implementation and expanded v1-v10 evidence authored, unrun; trusted-root Unix-only; unpromoted | [Project Revision Store v1](PROJECT-REVISION-STORE-V1.md), injected current-euid-owned `0700` held-root authority plus explicit same-principal, ancestor, and Darwin-ACL host preconditions, once-per-invocation bounded replay, complete selected-entry semantic replay, no-clobber publication, authority-neutral post-pivot location, read-only quarantine of one untraversed inert stage identity, and ordinary Project-v9 Phase-A admission | Execute literal v1-v10 round trips and the full hostile programme on required Unix hosts; freeze and implement an equally strong safe Windows authority before any cross-platform claim, and measure explicit retained revision reuse without promoting the store to an ambient cache. |
...
| Requirement | Status | Evidence owner | Complete when |
| --- | --- | --- | --- |
| Interface-first packages and target matrices | Partial; semantic lock snapshot and multi-package capsule/build v2 authored, unrun and unpromoted | [Package Report v1](PACKAGE-REPORT-V1.md), [Semantic Package Report v2](PACKAGE-REPORT-V2.md), [Offline Package Lock v1](OFFLINE-PACKAGE-LOCK-V1.md), [Offline Semantic Lock v2](OFFLINE-SEMANTIC-PACKAGE-LOCK-V2.md), [Compatibility Evidence v1](OFFLINE-PACKAGE-COMPATIBILITY-EVIDENCE-V1.md), [Offline Resolver v1](OFFLINE-PACKAGE-RESOLVER-V1.md), [Published Semantic Lock Snapshot v1](OFFLINE-PUBLISHED-SEMANTIC-LOCK-SNAPSHOT-V1.md), [Multi-Package Source Capsule v1](OFFLINE-MULTI-PACKAGE-SOURCE-CAPSULE-V1.md), [Effect-Free Wasm Package Build v1](OFFLINE-PURE-WASM-PACKAGE-BUILD-V1.md), [Linked Scalar Wasm Package Build v2](OFFLINE-LINKED-SCALAR-WASM-PACKAGE-BUILD-V2.md) | Execute the authored hostile snapshot/resolver/capsule/v1-v2 build/publication evidence; then add general consumer/source compatibility and version negotiation, supported publication, trusted provenance, registry, and conformance. |

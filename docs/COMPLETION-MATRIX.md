...
| Web and portable components | Partial | Scalar Core Wasm, public scalar/nested and generic Copy records, bounded generic/prelude/typed-`?` copy-variant Core Wasm, narrow owned-resource Wasm, and private WIT/component evidence exist. Portable Result v3, Source-Result v4, and Scalar Algebraic v5 runners are hosted green. Private Nested Record Component v6 fixes one `semaprax:private@0.4.0` nested scalar-record transform; local exact DAG/layout/profile KATs, hostile/upstream/default-consumer gates, and security review are green, while its pinned Rust 1.97.1/Wasmtime 47 typed runtime remains hosted pending. General algebraic mapping, general/empty/generic/resource component records, imports/capabilities, callable/FFI aggregate signatures, browser/multi-engine conformance, and public API/ABI remain open |
...
green. Its pinned Rust 1.97.1/Wasmtime 47 typed runtime remains hosted pending
and is not credited green.
...
| WebAssembly core/components | Partial | Validated stable-ID HIR lowers to direct Wasm core with browser ES runtime, checked arithmetic, contracts, HTML, `semaprax.web.v3`, public nested scalar and exact-instance generic Copy records, bounded generic/prelude copy variants, and hosted bounded typed-`Result` and typed-`Option` propagation with complete poison, exact concrete layouts, invalid-tag closure, shared postconditions, and restored shadow-stack state. Generic records are locally green through 4,096-call Node re-entry. A Node-executed `semaprax.wasm-owned.v1` subset covers one direct trivial resource. Private components v1-v5 retain their exact evidence; private nested-record Component v6 is local/security green but its isolated pinned-Rust-1.97.1 typed runtime remains hosted pending | Browser/WASI modules, general source-language algebraic Component mapping, general/resource-bearing records or variants, imports, async/capabilities, multi-engine conformance, general canonical resource ABI, stable public aggregate ABI, callable/FFI aggregate signatures, sandboxing, cross-realm/worker identity, public component API/ABI, and production native-host/Wasm conformance verified |
...
| WIT and WebAssembly Components | Partial | Deterministic private `SPXWIT01` boundary plus standalone v1, checked v2, Portable Result v3, Source-Result v4, and Scalar Algebraic v5 remain frozen; v3-v5 typed runners are hosted green. Private Nested Record Component v6 fixes package `semaprax:private@0.4.0`, interface `nested-records`, world `semaprax-private-v6`, and one nested scalar-record `transform` export. Its exact source/core/Inner-layout/Outer-layout/profile/component/DAG KATs, canonical reconstruction, mutation/cross-version closure, upstream validation, default-consumer hiding, local core execution, source locks, and security review are green; pinned Rust 1.97.1/Wasmtime 47 typed execution is hosted pending | General source selection/export, general/empty/generic/resource records or algebraic carriers, imports/capabilities, futures/streams, callbacks/reentrancy, browser and multi-engine conformance, package/version negotiation, callable/FFI aggregate signatures, public API/ABI, and `SPX-B104`/`SPX-W111` admission verified |

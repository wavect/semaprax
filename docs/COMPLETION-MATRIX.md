...
Public Agent Runtime v1 is hosted GREEN at 8cf29aff8d1be3ccf74c36bc8c837f0c666ca067 (run 31591039261, 12/12 jobs, private and public deterministic fake-host gates on Ubuntu, macOS, and Windows). Private Economic Agent A+B implementation has local/hosted evidence pending and public C remains held.
...
| Native code and interop | Partial | Scalar C11/Clang and bounded private callable/resource evidence exist. Versioned bidirectional native Rust interoperability is now an explicit roadmap gate: generated safe Rust callers for admitted SEMAPRAX exports and generated SEMAPRAX adapters for admitted Rust declarations must prove matching identity, layout, ownership, panic/error, thread, effect, capability, and allocation semantics without a Wasm detour. Public general native execution, that Rust boundary, and C/Objective-C/Swift/Kotlin ecosystem import remain open |

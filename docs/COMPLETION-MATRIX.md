...
adapters, and no hosted promotion. Current totals are 43 Partial/13 Missing.
...
| Sandboxed builds and dependencies | Missing | —; Project Manifest v1 has no resolver, lockfile, dependency graph, package registry, or capability sandbox | No ambient network/home/secrets; declared build capabilities and hostile package tests verified |

...
The human/agent projection dashboard now also includes the bounded local-only
...
404/404, full-preservation, and security gates are green. Hosted evidence is
pending. This does not change the dashboard
...
identity-bearing CleanupPlan content may rebase; hosted evidence is pending.

...
| Consuming scalar `Iter<T>` / `IterStep<T>` operations, generic iterator operations, `for own` traversal, and same-owner renewal | [Owning Iterators v1](OWNING-ITERATORS-V1.md), [Owning Iterator Loops v1](OWNING-ITERATOR-LOOPS-V1.md), [Owning Iterator Renewal v1](OWNING-ITERATOR-RENEWAL-V1.md), [Generic Iterator Helpers v1](GENERIC-ITERATORS-V1.md), [Generic Iterator Operations v1](GENERIC-ITERATOR-OPERATIONS-V1.md), [RFC 0003](RFC-0003-CLEANUP-AND-RESOURCE-ABI.md) |

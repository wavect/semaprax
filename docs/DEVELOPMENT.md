...
| Consuming scalar `Iter<T>` / `IterStep<T>` operations and `for own` traversal | [Owning Iterators v1](OWNING-ITERATORS-V1.md), [Owning Iterator Loops v1](OWNING-ITERATOR-LOOPS-V1.md), [Generic Iterator Helpers v1](GENERIC-ITERATORS-V1.md), [RFC 0003](RFC-0003-CLEANUP-AND-RESOURCE-ABI.md) |

...
| Universal semantic transaction kernel or typed operation | [Universal Semantic Transaction v1](UNIVERSAL-SEMANTIC-TRANSACTION-V1.md), [Canonical Semantic Workspace Revision v1](CANONICAL-SEMANTIC-WORKSPACE-REVISION-V1.md), [Project Candidates v1](PROJECT-CANDIDATES-V1.md) |

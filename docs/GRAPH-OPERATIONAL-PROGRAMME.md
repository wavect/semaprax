...
| Editor typed holes | [VS Code Adapter v1](VSCODE-SAVED-SOURCE-ADAPTER-V1.md#typed-hole-workflow); three-kind hole planning, compact facets, bound fill scratches and explicit completion, authored/unrun; repair UX and editor-host execution remain open |

...
| Artifact deltas | [Artifact Delta v1](PROJECT-CANDIDATE-ARTIFACT-DELTA-V1.md); actual base/candidate Web/npm and [OpenAPI](IMAGE-OPENAPI-ARTIFACTS-V1.md) file and stable export comparisons after full replay, under the existing build grant, authored/unrun |
...
| Target/artifact queries | [Target and Artifact Projections v1](IMAGE-TARGET-ARTIFACTS-V1.md) and [OpenAPI Artifacts v1](IMAGE-OPENAPI-ARTIFACTS-V1.md); actual pathless source-bound carrier construction and replay |

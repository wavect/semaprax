...
Status: implemented pathless image/candidate and transport projection; **HOSTED GREEN** under the
[v0.4.0 release baseline](RELEASE-0.4.0-STATUS.md).
C source/header projection is not native execution or a general public ABI.

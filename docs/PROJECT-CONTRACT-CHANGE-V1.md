...
Release-tested cases in `tests/project_candidate/candidates.rs` cover ordered
...
rejection. The implemented corpus is HOSTED GREEN; the broader product goal remains Partial.

...
matrix on Linux, macOS, and Windows, plus an explicit Rust 1.88 minimum-version
...
`libloading 0.9.0`; execute the x86_64 O0/O2 providers from canonical paths in

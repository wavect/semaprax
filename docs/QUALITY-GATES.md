...
The committed Windows gate runs
`runtime_loader_windows::windows_callable_dependency_search_excludes_cwd_and_legacy_path`
and explicitly reruns the complete generated O0/O2 callable corpus. It must not
be cited as Windows evidence until both commands pass in a green public CI run.

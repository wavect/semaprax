...
The executable v0.1 subset supports typed `i64`/`bool` functions and expressions. This subset exists to validate the graph and transaction architecture before expanding syntax.

...
All 34 packages listed in `std/packages.json` have the accepted **HOSTED GREEN**
v0.4.0 baseline for their admitted profiles. The inventory is nine core,
sixteen portable, three alloc, three hosted, one agent and two test packages.

...
- [Generic argument inference v3](GENERIC-ARGUMENT-INFERENCE-V3.md)
...
- [Generic Explicit Forwarding v1](GENERIC-EXPLICIT-FORWARDING-V1.md)
- [Generic Multi-Owner Records v1](GENERIC-MULTI-OWNER-RECORDS-V1.md)
- [Generic Owned Record Composition v2](GENERIC-OWNED-RECORD-COMPOSITION-V2.md)
- [Generic Owned Result v1](GENERIC-OWNED-RESULT-V1.md)
...
- [Public Generic Ownership Milestone v1](PUBLIC-GENERIC-OWNERSHIP-MILESTONE-V1.md)
...
- [Host Operation Outcome v1](HOST-OPERATION-OUTCOME-V1.md)
...
- [Agent Proposal to Runtime v1 Compatibility v1](AGENT-PROPOSAL-RUNTIME-V1-COMPATIBILITY-V1.md)
...
- [Structured tasks runtime](STRUCTURED-TASKS-RUNTIME-V1.md)

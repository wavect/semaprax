...
| `examples/network-http-project` | Project schema v12 under `network-command.v1`: deterministic fixture-backed TCP/HTTP execution with explicit network capabilities | `semaprax test examples/network-http-project/semaprax.toml` → `project tests passed`; `run` → `0` | [Project Manifest v1](../docs/PROJECT-MANIFEST-V1.md), [Bounded Language Network I/O v1](../docs/BOUNDED-LANGUAGE-NETWORK-IO-V1.md) |

...
for variable in \
  ...
  SEMAPRAX_IOS_SWIFT_DEVICE_IDENTITY_MAX_SOURCE \
  SEMAPRAX_IOS_SWIFT_SIM_ARM64_IDENTITY_MAX_SOURCE \
  SEMAPRAX_IOS_SWIFT_SIM_X86_64_IDENTITY_MAX_SOURCE \
  SEMAPRAX_IOS_SWIFT_DEVICE_CHECKED_ADD_OVERFLOW_SOURCE \
  SEMAPRAX_IOS_SWIFT_SIM_ARM64_CHECKED_ADD_OVERFLOW_SOURCE \
  SEMAPRAX_IOS_SWIFT_SIM_X86_64_CHECKED_ADD_OVERFLOW_SOURCE \
  SEMAPRAX_IOS_SWIFT_DEVICE_ENSURES_FALSE_SOURCE \
  SEMAPRAX_IOS_SWIFT_SIM_ARM64_ENSURES_FALSE_SOURCE \
  SEMAPRAX_IOS_SWIFT_SIM_X86_64_ENSURES_FALSE_SOURCE \
...
copy_input "$SEMAPRAX_IOS_SWIFT_DEVICE_IDENTITY_MAX_SOURCE" "$work/device-identity-max.c"
copy_input "$SEMAPRAX_IOS_SWIFT_SIM_ARM64_IDENTITY_MAX_SOURCE" "$work/simulator-arm64-identity-max.c"
copy_input "$SEMAPRAX_IOS_SWIFT_SIM_X86_64_IDENTITY_MAX_SOURCE" "$work/simulator-x86_64-identity-max.c"
copy_input "$SEMAPRAX_IOS_SWIFT_DEVICE_CHECKED_ADD_OVERFLOW_SOURCE" "$work/device-checked-add-overflow.c"
copy_input "$SEMAPRAX_IOS_SWIFT_SIM_ARM64_CHECKED_ADD_OVERFLOW_SOURCE" "$work/simulator-arm64-checked-add-overflow.c"
copy_input "$SEMAPRAX_IOS_SWIFT_SIM_X86_64_CHECKED_ADD_OVERFLOW_SOURCE" "$work/simulator-x86_64-checked-add-overflow.c"
copy_input "$SEMAPRAX_IOS_SWIFT_DEVICE_ENSURES_FALSE_SOURCE" "$work/device-ensures-false.c"
copy_input "$SEMAPRAX_IOS_SWIFT_SIM_ARM64_ENSURES_FALSE_SOURCE" "$work/simulator-arm64-ensures-false.c"
copy_input "$SEMAPRAX_IOS_SWIFT_SIM_X86_64_ENSURES_FALSE_SOURCE" "$work/simulator-x86_64-ensures-false.c"
...
compile_fixture iphoneos "$device_target" 2 "$work/device-identity-max.c" "$work/device-identity-max-o2.o"
compile_fixture iphoneos "$device_target" 2 "$work/device-checked-add-overflow.c" "$work/device-checked-add-overflow-o2.o"
compile_fixture iphoneos "$device_target" 2 "$work/device-ensures-false.c" "$work/device-ensures-false-o2.o"
...
compile_fixture iphonesimulator "$simulator_arm64_target" 0 "$work/simulator-arm64-identity-max.c" "$work/simulator-arm64-identity-max-o0.o"
compile_fixture iphonesimulator "$simulator_arm64_target" 0 "$work/simulator-arm64-checked-add-overflow.c" "$work/simulator-arm64-checked-add-overflow-o0.o"
compile_fixture iphonesimulator "$simulator_arm64_target" 0 "$work/simulator-arm64-ensures-false.c" "$work/simulator-arm64-ensures-false-o0.o"
...
compile_fixture iphonesimulator "$simulator_arm64_target" 2 "$work/simulator-arm64-identity-max.c" "$work/simulator-arm64-identity-max-o2.o"
compile_fixture iphonesimulator "$simulator_arm64_target" 2 "$work/simulator-arm64-checked-add-overflow.c" "$work/simulator-arm64-checked-add-overflow-o2.o"
compile_fixture iphonesimulator "$simulator_arm64_target" 2 "$work/simulator-arm64-ensures-false.c" "$work/simulator-arm64-ensures-false-o2.o"
...
compile_fixture iphonesimulator "$simulator_x86_target" 2 "$work/simulator-x86_64-identity-max.c" "$work/simulator-x86_64-identity-max-o2.o"
compile_fixture iphonesimulator "$simulator_x86_target" 2 "$work/simulator-x86_64-checked-add-overflow.c" "$work/simulator-x86_64-checked-add-overflow-o2.o"
compile_fixture iphonesimulator "$simulator_x86_target" 2 "$work/simulator-x86_64-ensures-false.c" "$work/simulator-x86_64-ensures-false-o2.o"
...
combine_archive "$work/lib-device.a" \
  "$work/device-o2.o" "$work/device-requires-false-o2.o" \
  "$work/device-identity-max-o2.o" "$work/device-checked-add-overflow-o2.o" "$work/device-ensures-false-o2.o" "$work/host-device.a"
combine_archive "$work/lib-simulator-arm64-o0.a" \
  "$work/simulator-arm64-o0.o" "$work/simulator-arm64-requires-false-o0.o" \
  "$work/simulator-arm64-identity-max-o0.o" "$work/simulator-arm64-checked-add-overflow-o0.o" "$work/simulator-arm64-ensures-false-o0.o" "$work/host-simulator-arm64.a"
combine_archive "$work/lib-simulator-arm64-o2.a" \
  "$work/simulator-arm64-o2.o" "$work/simulator-arm64-requires-false-o2.o" \
  "$work/simulator-arm64-identity-max-o2.o" "$work/simulator-arm64-checked-add-overflow-o2.o" "$work/simulator-arm64-ensures-false-o2.o" "$work/host-simulator-arm64.a"
combine_archive "$work/lib-simulator-x86_64-o2.a" \
  "$work/simulator-x86_64-o2.o" "$work/simulator-x86_64-requires-false-o2.o" \
  "$work/simulator-x86_64-identity-max-o2.o" "$work/simulator-x86_64-checked-add-overflow-o2.o" "$work/simulator-x86_64-ensures-false-o2.o" "$work/host-simulator-x86_64.a"
...
vtool -show-build "$work/simulator-arm64-identity-max-o2.o" | grep -F 'platform IOSSIMULATOR' >/dev/null
vtool -show-build "$work/simulator-arm64-checked-add-overflow-o2.o" | grep -F 'platform IOSSIMULATOR' >/dev/null
vtool -show-build "$work/simulator-arm64-ensures-false-o2.o" | grep -F 'platform IOSSIMULATOR' >/dev/null
...
vtool -show-build "$work/device-identity-max-o2.o" | grep -F 'platform IOS' >/dev/null
vtool -show-build "$work/device-checked-add-overflow-o2.o" | grep -F 'platform IOS' >/dev/null
vtool -show-build "$work/device-ensures-false-o2.o" | grep -F 'platform IOS' >/dev/null
...
_main
_spx_private_apple_swift_fixture_ca_v1_open
_spx_private_apple_swift_fixture_ef_v1_open
_spx_private_apple_swift_fixture_id_v1_open
_spx_private_apple_swift_fixture_rf_v1_open
_spx_private_apple_swift_fixture_v1_open
_spx_private_apple_swift_v1_adopt_checked_add_overflow
_spx_private_apple_swift_v1_adopt_ensures_false
_spx_private_apple_swift_v1_adopt_owned
...
_spx_private_apple_swift_v1_execute_checked_add_overflow
_spx_private_apple_swift_v1_execute_ensures_false
_spx_private_apple_swift_v1_execute_identity_max
_spx_private_apple_swift_v1_execute_requires_false
EOF
expected_app_exports='_spx_private_apple_swift_fixture_ca_v1_open
_spx_private_apple_swift_fixture_ef_v1_open
_spx_private_apple_swift_fixture_id_v1_open
_spx_private_apple_swift_fixture_rf_v1_open
_spx_private_apple_swift_fixture_v1_open

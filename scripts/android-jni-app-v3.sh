...
readonly expected_result="SEMAPRAX_ANDROID_JNI_V1_OK api=35 abi=$android_abi o0=explicit o2=cleaner handle=0001000001000001 declared=0000006b00000007 unexpected=0000004500000001 finalizers=1:13,0:11 publication=no-owned allocations=0 handles=0 rf=1 om=1"

...
fn static_token(value: &str) -> Result<&'static str> {
    match value {
        ...
        "semaprax.cleanup-plan.v10" => Ok("semaprax.cleanup-plan.v10"),
        "semaprax.cleanup-plan.v11" => Ok("semaprax.cleanup-plan.v11"),
        "semaprax.cleanup-plan.v12" => Ok("semaprax.cleanup-plan.v12"),
        "semaprax.cleanup-plan.v13" => Ok("semaprax.cleanup-plan.v13"),

...
static COMMANDS: &[CommandSpec] = &[
    ...
    CommandSpec { id: CommandId::Lock, canonical: "lock", aliases: &[], availability: Availability::Public, global: true, usages: &["semaprax lock <manifest> [--write|--verify|--compare <baseline.lock>|--emit-interface|--compare-interface <baseline.json>]"] },
    CommandSpec { id: CommandId::Resolve, canonical: "resolve", aliases: &[], availability: Availability::Public, global: true, usages: &["semaprax resolve <manifest> --target <native64|wasm32> --cache <dir> [--write|--verify] [--max-bytes N]"] },

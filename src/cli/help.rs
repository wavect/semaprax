...
static COMMANDS: &[CommandSpec] = &[
    ...
    CommandSpec { id: CommandId::Resolve, canonical: "resolve", aliases: &[], availability: Availability::Public, global: true, usages: &["semaprax resolve <manifest> --target <native64|wasm32> --cache <dir> [--max-bytes N]"] },

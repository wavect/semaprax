...
static COMMANDS: &[CommandSpec] = &[
    ...
    CommandSpec { id: CommandId::Lock, canonical: "lock", aliases: &[], availability: Availability::Public, global: true, usages: &["semaprax lock <manifest> [--write|--verify|--compare <baseline.lock>]"] },

        ...
        let prepared = self.snapshot.with_authenticated_request(|_| {
            let (payload, mutation) = match method.operation {
                ...
                Operation::VNext(
                    ...
                    candidate_function_facets::prepare(action, params, image, registry)?,
                    candidates::Mutation::None,
                ),
                Operation::VNext(
                ...
                Operation::VNext(Action::DraftMerge) => {
                    draft_merge::prepare(params, image, registry)?
                }

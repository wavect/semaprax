                    ...
                    if ordered_parameters.is_some() {
                        ...
                        forms.push(json!({
                            ...
                            "owner_to_borrowed_slice":{
                                "source":"one_to_eight_distinct_authenticated_original_own_Bytes_parameters",
                                "maximum_replacements":8,
                                "provider_use":"exactly_one_unprojected_bytes_as_slice_builtin_call_per_owner",
                                ...
                                "excludes":["additive_owner_alias","duplicate_or_cross_owner_alias","String","borrow_Bytes","projected_or_nested_owner","more_than_eight_owner_conversions","external_package_source_rewrite","target_or_runtime_support_widening"],

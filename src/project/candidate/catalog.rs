                ...
                if self.changes.len() < MAX_CHANGES {
                    ...
                    if ordered_parameters.is_some() {
                        let mut constraints = vec![
                            ...
                            "own_bytes_retained_or_exactly_replaced_once",
                        ...
                        forms.push(json!({
                            ...
                            "borrowed_parameter_fields":["name","borrow_from"],
                            "borrowed_parameter":{
                            ...
                            "owner_to_borrowed_slice_fields":["name","borrow_slice_from_owner"],
                            "owner_to_borrowed_str_fields":["name","borrow_str_from_owner"],
                            "owner_to_borrowed_slice":{
                                "source":"authenticated_original_own_Bytes_parameter",
                                "provider_use":"exactly_one unprojected bytes_as_slice builtin call",
                                "result":"borrow Slice<u8>",
                            },
                            "owner_to_borrowed_str":{
                                "source":"authenticated_original_bare_owning_String_parameter",
                                "provider_use":"exactly_one unprojected string_as_str builtin call",
                                "result":"borrow str",
                            },
                            "owner_to_borrowed_view":{
                                "source":"one_to_eight_distinct_authenticated_original_own_Bytes_or_own_String_parameters",
                                ...
                                "caller_lowering":"stage_every_original_argument_left_to_right_then_derive_views_from_staged_owners_in_mapped_parameter_order",
                                "owner_cleanup":"caller_owned_ordinary_cleanup",
                                "mixed_owner_kinds":true,
                                "excludes":["additive_owner_alias","duplicate_or_cross_owner_alias","borrow_Bytes","projected_or_nested_owner","more_than_eight_owner_conversions","external_package_source_rewrite","target_or_runtime_support_widening"],
                                "full_project_replay":true,
                            },

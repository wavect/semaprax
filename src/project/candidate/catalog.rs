        ...
        if let Some(function) = selected {
                ...
                && self.changes.len() < MAX_CHANGES
            {
                ...
                operations.push(json!({
                    ...
                    "selector_source":"expression/catalog",
                    "constraints":["unique_authored_body_expression", "globally_new_explicit_identity", "compiler_derived_copy_captures", "checked_sized_copy_captures_and_result", "field_reads_capture_immutable_copy_root", "internally_created_resource_free_owners_only_in_nested_authored_blocks", "preserve_nested_block_cleanup_scope", "no_owned_pattern_bindings_or_assignments", "preserve_original_lazy_position_and_evaluation_order", "no_mutable_or_escaping_owned_captures", "no_borrowed_or_resource_values", "full_candidate_revalidation"],
                }));

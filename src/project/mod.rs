...
pub use scaffold::{
    derive_project_scaffold_v1, project_scaffold_inventory, replay_project_scaffold_v1,
    ProjectScaffoldFileV1, ProjectScaffoldV1, MAX_PROJECT_SCAFFOLD_DESCRIPTOR_BYTES,
    ...
    PROJECT_SCAFFOLD_SCHEMA, PROJECT_SCAFFOLD_TEMPLATES, PROJECT_SCAFFOLD_TEMPLATE_CALCULATOR,

...
pub use candidate::{
    ...
    MAX_PROJECT_CANDIDATE_BYTES, MAX_PROJECT_CANDIDATE_HOLES, MAX_SEMANTIC_CHANGE_BYTES,
    PROJECT_CANDIDATE_DRAFT_SCHEMA, PROJECT_CANDIDATE_HOLE_CONTEXT_SCHEMA,
    PROJECT_CANDIDATE_REBASE_SCHEMA, PROJECT_CANDIDATE_SCHEMA, SEMANTIC_CHANGE_REQUIREMENTS,

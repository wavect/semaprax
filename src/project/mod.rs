...
pub use scaffold::{
    ...
    replay_project_scaffold_v1, ProjectScaffoldFileV1, ProjectScaffoldV1, ScaffoldLayout,
    MAX_PROJECT_SCAFFOLD_DESCRIPTOR_BYTES, MAX_PROJECT_SCAFFOLD_NAME_BYTES,
    PROJECT_SCAFFOLD_FILE_COUNT, PROJECT_SCAFFOLD_INVENTORY, PROJECT_SCAFFOLD_LIBRARY_FILE_COUNT,
    PROJECT_SCAFFOLD_LIBRARY_INVENTORY, PROJECT_SCAFFOLD_SCHEMA, PROJECT_SCAFFOLD_SCHEMA_V3,
    PROJECT_SCAFFOLD_TEMPLATES, PROJECT_SCAFFOLD_TEMPLATE_CALCULATOR,

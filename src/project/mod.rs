...
pub use manifest::{
    ...
    PROJECT_SCHEMA_V15, PROJECT_SCHEMA_V2, PROJECT_SCHEMA_V3, PROJECT_SCHEMA_V4, PROJECT_SCHEMA_V5,
...
pub use profile::{
    ...
    PROJECT_FILESYSTEM_CAPABILITIES_V1, PROJECT_HTTPS_COMMAND_CAPABILITIES_V1,

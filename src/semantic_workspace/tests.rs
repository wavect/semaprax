...
fn current_source_graph_schemas_are_admitted_without_widening_unknown_schemas() {
    ...
    assert!(is_source_graph_schema("semaprax.graph.v28"));
    assert!(is_source_graph_schema("semaprax.graph.v29"));
    assert!(is_source_graph_schema("semaprax.graph.v30"));
    assert!(is_source_graph_schema("semaprax.graph.v31"));
    assert!(is_source_graph_schema("semaprax.graph.v32"));
    assert!(is_source_graph_schema("semaprax.graph.v33"));
    assert!(is_source_graph_schema("semaprax.graph.v34"));
    assert!(is_source_graph_schema("semaprax.graph.v35"));
    assert!(is_source_graph_schema("semaprax.graph.v36"));
    assert!(is_source_graph_schema("semaprax.graph.v37"));
    assert!(is_source_graph_schema("semaprax.graph.v38"));
    assert!(is_source_graph_schema("semaprax.graph.v39"));
    assert!(is_source_graph_schema("semaprax.graph.v40"));
    assert!(is_source_graph_schema("semaprax.graph.v41"));

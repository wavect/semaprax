...
use capacity::{
    ...
    source_capacity_expr_type, source_capacity_match_next_scratch_peak, source_capacity_scope_live,
    source_capacity_scope_peak, source_transcript_frame_scratch_peak,
    ...
    source_type_scope_copy_totals, SourceCapacityContext,
};
use capacity::{source_capacity_functions, verify_byte_data_capacity};

...
#[cfg(test)]
fn reset_source_capacity_scope_peak() {
...
#[cfg(test)]
fn source_capacity_scope_peak() -> usize {
    SOURCE_CAPACITY_PEAK_SCOPES.with(std::cell::Cell::get)
}

#[cfg(test)]
fn source_capacity_scope_live() -> usize {
    SOURCE_CAPACITY_LIVE_SCOPES.with(std::cell::Cell::get)
}

#[cfg(test)]
fn source_capacity_match_next_scratch_peak() -> (usize, usize, usize) {
    (
...
#[cfg(test)]
fn source_type_scope_copy_totals() -> (usize, usize) {
    (
...
#[cfg(test)]
fn reset_source_transcript_scope_peak() {
...
#[cfg(test)]
fn source_transcript_scope_peak() -> usize {
    SOURCE_TRANSCRIPT_PEAK_SCOPES.with(std::cell::Cell::get)
}

#[cfg(test)]
fn source_transcript_scope_live() -> usize {
    SOURCE_TRANSCRIPT_LIVE_SCOPES.with(std::cell::Cell::get)
}

#[cfg(test)]
fn source_transcript_owned_map_allocations() -> usize {
    SOURCE_TRANSCRIPT_OWNED_MAP_ALLOCATIONS.with(std::cell::Cell::get)
}

#[cfg(test)]
fn source_transcript_frame_scratch_peak() -> (usize, usize) {
    (
...
impl VerifierFunctionSignature<'_> {
    ...
    fn implicit_unique_ownership(&self) -> bool {
        match self {

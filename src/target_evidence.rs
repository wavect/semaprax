...
"#;
    ...
    fn target_preview_rejects_changed_bytes_and_same_byte_identity_at_final_check() {
        ...
        let error =
            super::preview_with_hook(&source, &patch, |path| std::fs::write(path, &oversized))
                .unwrap_err();
        assert_eq!(error[0].code, "SPX-I207");
        assert_eq!(

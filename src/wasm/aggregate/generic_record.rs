//! Independent Core-Wasm admission for fully substituted generic records.
        ...
        match frame {
            Frame::Enter(ResolvedType::Bytes, _) => {
                owned_leaves = owned_leaves
                    .checked_add(1)
                    .ok_or_else(|| error("Wasm generic owned-leaf count overflowed"))?;
            ...
            Frame::Enter(ty @ ResolvedType::Nominal { .. }, depth) => {
                ...
                visited_fields = visited_fields
                    ...
                    .ok_or_else(|| error("Wasm generic visited-field count overflowed"))?;

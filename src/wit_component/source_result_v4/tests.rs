...
fn deterministic_v4_artifact_is_exactly_parsed_and_upstream_valid() {
    ...
    assert_eq!(
        ...
        [
            0x25, 0x16, 0x1b, 0xf5, 0xc5, 0xee, 0xc3, 0x7c, 0x13, 0xb6, 0x73, 0x3d, 0x30, 0xe2,
            0x72, 0xda, 0xda, 0xfe, 0x3e, 0xa3, 0x90, 0x5e, 0x8e, 0x05, 0x09, 0x9f, 0x36, 0x64,
            0xe8, 0x69, 0xe3, 0x2d,
        ],
    ...
    assert_eq!(
        ...
        [
            0xad, 0x47, 0xfd, 0x39, 0xfa, 0xf2, 0xc5, 0xf9, 0x5c, 0xfe, 0xf1, 0xca, 0x18, 0xf5,
            0xfd, 0x74, 0x65, 0x37, 0x27, 0xa8, 0x12, 0xf7, 0xbe, 0x76, 0xad, 0xa6, 0x2b, 0xc1,
            0xdb, 0x04, 0x81, 0xe6,
        ],
        "profile KAT changed"
    );
    assert_eq!(
        first.digest(),
        [
            0x63, 0x9f, 0x5c, 0xe9, 0x5a, 0x5d, 0x7b, 0x81, 0xe8, 0x4a, 0xc7, 0xf7, 0xd9, 0x97,
            0x66, 0x49, 0xae, 0xb9, 0x45, 0x10, 0x65, 0xee, 0xb3, 0x71, 0x6e, 0x5d, 0xba, 0xe1,
            0xe1, 0x10, 0x88, 0x85,
        ],
    ...
    assert_eq!(
        ...
        [
            0xad, 0xf8, 0x57, 0x01, 0xcc, 0xd4, 0xd4, 0xf0, 0x5c, 0x65, 0x74, 0x2b, 0x6c, 0x8c,
            0x65, 0x18, 0x0f, 0x8b, 0xe5, 0x91, 0xde, 0xa5, 0x8f, 0xba, 0xb8, 0xcc, 0x71, 0xdb,
            0x8f, 0x61, 0xbb, 0x78,
        ],

...
fn human_output_is_deterministic_with_known_and_absent_commits() {
    assert_eq!(
        ...
        "semaprax 0.4.1 (8b2d397f164ff93338d7b3935d1c2df291434458)\n"
    );
    assert_eq!(
...
fn json_output_is_canonical_and_has_one_terminal_lf() {
    assert_eq!(
        ...
        "{\"schema\":\"semaprax.version.v1\",\"version\":\"0.4.1\",\"commit\":\"8b2d397f164ff93338d7b3935d1c2df291434458\",\"maturity\":\"pre-alpha\",\"rust_min\":\"1.88\"}\n"
    );
    assert_eq!(

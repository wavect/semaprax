...
fn standalone_runner_is_pinned_private_and_outside_the_root_workspace() {
    ...
    for required in [
        ...
        "[workspace]",
        "resolver = \"2\"",
        "semaprax = { version = \"=0.4.1\", path = \"../..\", default-features = false, features = [\"unstable-wit-component-harness\"] }",
...
fn capability_and_dependency_policy_are_fail_closed() {
    ...
    for required in [
        ...
        "0xcf, 0x0c, 0xa8, 0xc7, 0x73, 0x0c, 0x59, 0x99",
        "0x8d, 0x4a, 0x21, 0x9e, 0x37, 0x7e, 0x97, 0x58",
        ...
        "0x74, 0x1f, 0xf8, 0x9e, 0x1e, 0xe6, 0x7d, 0x14",
        "0x96, 0x7b, 0x0c, 0x4a, 0xff, 0x16, 0xad, 0x55",
        "(left + 1) / right",
        ...
        "0xad, 0xf8, 0x57, 0x01, 0xcc, 0xd4, 0xd4, 0xf0",
        "0x25, 0x16, 0x1b, 0xf5, 0xc5, 0xee, 0xc3, 0x7c",
    ] {
        assert!(

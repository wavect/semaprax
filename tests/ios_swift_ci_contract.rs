...
fn private_ios_swift_project_is_offline_closed_and_source_locked() {
    ...
    for required in [
        ...
        "spx_private_apple_swift_fixture_rf_v1_open(void)",
        "spx_private_apple_swift_fixture_id_v1_open(void)",
        "spx_private_apple_swift_fixture_ca_v1_open(void)",
        "spx_private_apple_swift_fixture_ef_v1_open(void)",
        "spx_private_apple_swift_v1_adopt_pair",
        "spx_private_apple_swift_v1_adopt_single",
        "spx_private_apple_swift_v1_adopt_checked_add_overflow",
        "spx_private_apple_swift_v1_adopt_ensures_false",
        "spx_private_apple_swift_v1_adopt_owned",
        "spx_private_apple_swift_v1_consume",
        "uint32_t evidence_len",
        "spx_private_apple_swift_v1_execute_requires_false",
        "spx_private_apple_swift_v1_execute_checked_add_overflow",
        "spx_private_apple_swift_v1_execute_ensures_false",
        "spx_private_apple_swift_v1_execute_identity_max",
    ...
    for required in [
        ...
        "identity_max.expected_owned_result_ordinal != Some(0)",
    ...
    for required in [
        ...
        "0x000000010000000d",
        "0x000000000000000b",
        "selectedOrdinalKAT: UInt64 = 1",
        "finalizerPayloadKAT: UInt64 = UInt64.max",
        "witness evidence width changed",
        "witness finalizer count is not exactly one",
        "witness mutated a second owner slot",
        "CheckedAddOverflowEvidence",
        "selectedOrdinalKAT: UInt64 = 2",
        "checked-add-overflow evidence width changed",
        "checked-add-overflow finalizer count is not exactly one",
        "EnsuresFalseEvidence",
        "selectedOrdinalKAT: UInt64 = 3",
        "ensures-false evidence width changed",
        "ensures-false finalizer count is not exactly one",
        "publicationsKAT: UInt64 = 2",
        "ownedPayloadKAT: UInt64 = UInt64.max",
        "identity-max evidence width changed",
        "outward publication word is not the canonical identity-max count",
        "published identity was physically finalized",
    ...
    for required in [
        ...
        "spx_private_apple_swift_v1_execute_ensures_false",
        "spx_private_apple_swift_v1_execute_requires_false",
        "executeRequiresFalseOnOwner",
        "witness adoption rejection modified output handle",
        "spx_private_apple_swift_fixture_id_v1_open()",
        "spx_private_apple_swift_fixture_ca_v1_open()",
        "spx_private_apple_swift_fixture_ef_v1_open()",
        "spx_private_apple_swift_v1_adopt_owned(",
        ...
        "CheckedAddOverflowEvidence.finalizerPayloadKAT",
        "EnsuresFalseEvidence.finalizerPayloadKAT",
        "spx_private_apple_swift_v1_execute_identity_max",
        "spx_private_apple_swift_v1_execute_checked_add_overflow",
        "spx_private_apple_swift_v1_execute_ensures_false",
        "executeIdentityMaxOnOwner",
        "owned-result adoption rejection modified output handle",
    ...
    for required in [
        ...
        "openCheckedAddOverflow",
        "adoptCheckedAddOverflow",
...
fn private_ios_swift_hosted_gate_is_mandatory_and_fail_closed() {
    ...
    for required in [
        ...
        "dtolnay/rust-toolchain@02cb101ec7c40f2c49e1d9714d64511d8e1b74de # master",
        "toolchain: 1.97.1",
    ...
    for required in [
        ...
        "simulator-arm64.c",
        "simulator-x86_64.c",
        "device-arm64-requires-false.c",
        "simulator-arm64-requires-false.c",
        "simulator-x86_64-requires-false.c",
        "device-arm64-identity-max.c",
        "simulator-arm64-identity-max.c",
        "simulator-x86_64-identity-max.c",
        "device-arm64-checked-add-overflow.c",
        "simulator-arm64-checked-add-overflow.c",
        "simulator-x86_64-checked-add-overflow.c",
        "device-arm64-ensures-false.c",
        "simulator-arm64-ensures-false.c",
        "simulator-x86_64-ensures-false.c",
        "aarch64-apple-ios",
    ...
    for required in [
        ...
        "device-requires-false-o2.o",
        "simulator-arm64-requires-false-o0.o",
        "simulator-arm64-requires-false-o2.o",
        "simulator-x86_64-requires-false-o2.o",
        "device-identity-max-o2.o",
        "simulator-arm64-identity-max-o0.o",
        "simulator-arm64-identity-max-o2.o",
        "simulator-x86_64-identity-max-o2.o",
        "device-checked-add-overflow-o2.o",
        "simulator-arm64-checked-add-overflow-o0.o",
        "simulator-arm64-checked-add-overflow-o2.o",
        "simulator-x86_64-checked-add-overflow-o2.o",
        "device-ensures-false-o2.o",
        "simulator-arm64-ensures-false-o0.o",
        "simulator-arm64-ensures-false-o2.o",
        "simulator-x86_64-ensures-false-o2.o",
        "xcrun lipo -create",
    ...
    for required in [
        ...
        "fn requires_false_witness(",
        "fn checked_add_overflow_witness(",
        "fn ensures_false_witness(",
        "fn identity_max_witness(",
        "SessionShape::SingleOwnedResult",
        "SessionShape::CheckedAddOverflow",
        "SessionShape::EnsuresFalse",
        "spx_private_apple_swift_v1_adopt_single",
        "spx_private_apple_swift_v1_adopt_checked_add_overflow",
        "spx_private_apple_swift_v1_adopt_ensures_false",
        "spx_private_apple_swift_v1_adopt_owned",
        ...
        "REQUIRES_FALSE_SELECTED_ORDINAL",
        "ExecuteOutcome::Owned",
        "owner_ordinal: IDENTITY_MAX_OWNER_ORDINAL",
        "Publication::Owned(IDENTITY_MAX_OWNER_ORDINAL)",

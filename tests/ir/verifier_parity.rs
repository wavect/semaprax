...
{"code":"SPX-T203","severity":"error","message":"unknown function `missing`","path":"fixtures/verifier-mixed.spx","location":{"line":11,"column":5,"start":216,"end":230},"help":"declare `missing` in this module, or in a project import it directly after the `module` line: `use function @id(\"stable.id\") from other.module as missing;`"}

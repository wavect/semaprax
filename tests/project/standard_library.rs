...
use text_conformance::{
    assert_text_interpreter_conformance, compile_c, run_returns_zero,
    run_text_package_native_conformance, run_text_package_wasm_conformance,
};
...
#[path = "standard_library/base64.rs"]
mod base64;
...
#[path = "standard_library/path_normalize.rs"]
mod path_normalize;
...
#[path = "standard_library/tracing_backend_audit.rs"]
mod tracing_backend_audit;

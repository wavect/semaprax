...
{"code":"SPX-S103","severity":"warning","message":"function `helper` has an automatic identity that changes when renamed","path":"fixtures/verifier-mixed.spx","location":{"line":5,"column":4,"start":72,"end":78},"help":"add @id(\"your.namespace.symbol\") before the declaration"}
{"code":"SPX-O001","severity":"error","message":"resource parameter `helper.value` needs `own`, `borrow`, or `shared`","path":"fixtures/verifier-mixed.spx","location":{"line":5,"column":11,"start":79,"end":84},"help":"use `value: own Buffer` to transfer ownership"}
{"code":"SPX-O002","severity":"error","message":"ownership mode `own` is only valid for resource types; `i64` is a value type","path":"fixtures/verifier-mixed.spx","location":{"line":5,"column":26,"start":94,"end":100},"help":null}
{"code":"SPX-T203","severity":"error","message":"unknown function `missing`","path":"fixtures/verifier-mixed.spx","location":{"line":8,"column":5,"start":151,"end":165},"help":null}
{"code":"SPX-E101","severity":"error","message":"function `helper` uses `network.send` but module `test.verifier_parity` does not permit it","path":"fixtures/verifier-mixed.spx","location":{"line":5,"column":1,"start":69,"end":167},"help":null}
{"code":"SPX-T105","severity":"error","message":"executable module must define `fn main() -> i64`","path":"fixtures/verifier-mixed.spx","location":{"line":5,"column":1,"start":69,"end":167},"help":null}"#
    );
}
